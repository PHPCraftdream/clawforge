...
import { runCheck, requiresModel, summarize, acceptanceSpecError } from "../framework/commands/accept.ts";
import type { AcceptanceCheck } from "../framework/commands/accept.ts";
