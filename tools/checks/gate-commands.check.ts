...
import { runGateCommand, gateHelpLines, gateCommandHelp, type GateCommand } from "../framework/gate.ts";
import { inputSchema, toArgv, validate } from "../framework/mcp-server.ts";
