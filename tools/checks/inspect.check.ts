...
import { gatherInspection, renderJson, doctor } from "../framework/commands/inspect.ts";
import { recipeFileChecksums, agentBundleChecksums } from "../framework/checksums.ts";
import { currentComposition, lockFile } from "../framework/commands/lock.ts";
