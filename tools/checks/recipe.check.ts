// Checks recipe loading and listing (tools/framework/recipe.ts) plus the guard rails in the
// `install` branch of tools/framework/commands/recipe.ts — a disabled recipe refuses to build
...
import { recipe } from "../framework/commands/recipe.ts";
