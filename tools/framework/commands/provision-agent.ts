...
import { containerPaths } from "../mounts.ts";
import { safeName } from "../names.ts";
import { openclawCli, openclawCliJson } from "../openclaw-cli.ts";
import { takeLock, lockHeldHere } from "../instance-lock.ts";
import { newOperationId } from "../operations.ts";
import { readLedger, recordOwned, forgetOwned, ownerOf, updateOwnedPromptFiles } from "../set/ledger.ts";
import type { Ledger } from "../set/ledger.ts";
import type { OwnedKind } from "../set/ledger.ts";
import { readInstalledSet } from "../set/install.ts";
import { setSourceDir } from "../set/source.ts";
import { setManifestId } from "../set/model.ts";
 ...
 *  tools/framework/recipe.ts already draws for recipe.json. */
