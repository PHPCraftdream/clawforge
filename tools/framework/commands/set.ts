...
import { spawnLocal } from "../transport.ts";
...
import { frameworkVersion, readLock } from "./lock.ts";
import { parseAgentConfig, removeOwnedObject } from "./provision-agent.ts";
import type { AgentConfig } from "./provision-agent.ts";
import { takeLock, lockHeldHere } from "../instance-lock.ts";
import { newOperationId } from "../operations.ts";
...
import { withSetSource } from "../set/source.ts";
import { loadChecks } from "./accept.ts";
import type { AcceptanceCheck } from "./accept.ts";
import { DESIRED_STATE_PATH, buildSetManifest, canonicalJson, setManifestId } from "../set/model.ts";
 ...
 *  instance. framework/secrets.ts's requirements(ctx) reads openclaw.json ON THE TARGET,
