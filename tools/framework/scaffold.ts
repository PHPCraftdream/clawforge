...
import { monorepoRoot, frameworkRoot, parseEnv } from "./env.ts";
...
import { defineApp } from "../../tools/framework/app.ts";
import { mountPoints } from "../../tools/framework/mounts.ts";
import { openclawCommands } from "../../tools/framework/commands/index.ts";
